...
@section('conteudo')
    ...
    <div id="img" class="white" style="border-radius: 50px">
        <div id="imgs">
            <img src="{{ $animal['imagem1']}}" alt="{{ $animal['nome'] ?? 'Animal' }}">
            <img src="{{ $animal['imagem2']}}" alt="{{ $animal['nome'] ?? 'Animal' }}">
            <img src="{{ $animal['imagem3']}}" alt="{{ $animal['nome'] ?? 'Animal' }}">
            <img src="{{ $animal['imagem4']}}" alt="{{ $animal['nome'] ?? 'Animal' }}">
        </div>
        @if(!$animal['nome'])
